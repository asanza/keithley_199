...
START_SEQUENCE(seq_300KOhm){
    0xC7B1E1D5, 0xC7B1E1D4, 0xC7B1E1D2, 
    0xC7B1E1D5, 0xC7B1E1D4, 0xA7B5E192, 
    0xA7B5E195, 0xA7B5E194, 0x87B5E192, 
    0x97B5E192, 
    0x97B5E195, 0x97B5E194, 0x87B5E19A, 
    0x87B5E19D, 0x87B5E19C, 0xC7B1E1D2,     
}END_SEQUENCE(seq_300KOhm)

START_SEQUENCE(seq_3MegOhm){
    0xCBB1E1D5,0xCBB1E1D4,0xCBB1E1D2,
    0xCBB1E1D5,0xCBB1E1D4,0xABB5E192,
    0xABB5E195,0xABB5E194,0x8BB5E192,
    0x9BB5E192,
    0x9BB5E195,0x9BB5E194,0x8BB5E19A,
    0x8BB5E19D,0x8BB5E19C,0xCBB1E1D2,
...
static adc_control_sequence* get_res4w_seq(adc_range range)
{
    switch (range) {
        ...
        return &seq_3KOhm;
        case ADC_RANGE_30K: seq_30KOhm.actual_value = 0;
        return &seq_30KOhm;
        case ADC_RANGE_300K: seq_300KOhm.actual_value = 0;
        return &seq_300KOhm;
        case ADC_RANGE_3M: seq_3MegOhm.actual_value = 0;
        return &seq_3MegOhm;
        default: return NULL;
    }
    return NULL;
